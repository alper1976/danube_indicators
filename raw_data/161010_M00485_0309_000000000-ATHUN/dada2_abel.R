...
# sequencing run
# 161010_M00485_0309_000000000-ATHUN
...
option_list = list(
    ...
    make_option(c("-p", "--path"),
        type="character",
        default="/work/users/alexaei/output/161010_M00485_0309_000000000-ATHUN/AdaptersRemoved",
        help="path to input",
        metavar="character"),

    make_option(c("-o", "--output"),
        type="character",
        default="/work/users/alexaei/output/161010_M00485_0309_000000000-ATHUN",
        help="path to output",
        metavar="character"),
