...
# sequencing run
# 131002_M00485_0074_000000000-A5GKR
...
option_list = list(
    ...
    make_option(c("-p", "--path"),
        type="character",
        default="/work/users/alexaei/output/jds2/pairs",
        help="path to input",
        metavar="character"),

    make_option(c("-o", "--output"),
        type="character",
        default="/work/users/alexaei/output/jds2",
        help="path to output",
        metavar="character"),
...
opt = parse_args(OptionParser(option_list=option_list))
    ...
    path_to_fwd = list.files(path_to_input, pattern = "_1.paired.fastq.gz", all.files = TRUE, full.names = TRUE, recursive = FALSE)
    path_to_rev = list.files(path_to_input, pattern = "_2.paired.fastq.gz", all.files = TRUE, full.names = TRUE, recursive = FALSE)
  ...
  # Infer Sequence variance
    ...
    filtered_fwd = list.files(filtered_path, pattern = "_1.paired.fastq.gz", all.files = TRUE, full.names = TRUE, recursive = TRUE)
    filtered_rev = list.files(filtered_path, pattern = "_2.paired.fastq.gz", all.files = TRUE, full.names = TRUE, recursive = TRUE)
